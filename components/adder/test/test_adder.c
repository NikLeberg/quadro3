 ...
 *
 */
TEST_CASE("one added to one equals two", "[adder][qemu]") {
 ...
 *
 */
TEST_CASE("five added to negative five equals zero", "[adder][qemu]") {
 ...
 *
 */
TEST_CASE("struct one added to one equals two", "[adder][qemu]") {
    TEST_ASSERT_EQUAL(add1(5, -5), 0);
