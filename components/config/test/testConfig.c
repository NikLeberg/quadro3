 ...
 *
 */
TEST_CASE("assumptionsAreValid", "[config][qemu]") {
 ...
 *
 */
TEST_CASE("canSetupConfigvariables", "[config][qemu]") {
#ifndef TEST_IN_QEMU
    ...
    // Neu aufsetzen
    TEST_ASSERT_FALSE(
        CONFIG_REGISTER("c1", "group1", "variable1", c1group1variable1, 1.11));
    TEST_ASSERT_EQUAL_FLOAT(1.11, c1group1variable1);
    TEST_ASSERT_FALSE(
        CONFIG_REGISTER("c1", "group1", "variable2", c1group1variable2, 1.12));
    TEST_ASSERT_EQUAL_FLOAT(1.12, c1group1variable2);
    TEST_ASSERT_FALSE(
        CONFIG_REGISTER("c1", "group2", "variable1", c1group2variable1, 1.21));
    TEST_ASSERT_EQUAL_FLOAT(1.21, c1group2variable1);
    TEST_ASSERT_FALSE(
        CONFIG_REGISTER("c2", "group1", "variable1", c2group1variable1, 2.11));
 ...
 *
 */
TEST_CASE("canGetSetConfigvariables", "[config][qemu]") {
    ...
    TEST_ASSERT_FALSE(
        configGet("c1", "group1", "variable1", &getType, &getValue));
 ...
 *
 */
TEST_CASE("unregisterOnlyUnregistersTheRightOne", "[config][qemu]") {
    TEST_ASSERT_FALSE(configUnregister("c1", true));
    float getValue;
    configType_t getType;
    TEST_ASSERT_TRUE(
        configGet("c1", "group1", "variable1", &getType, &getValue));
    TEST_ASSERT_TRUE(
        configGet("c1", "group1", "variable2", &getType, &getValue));
    TEST_ASSERT_TRUE(
        configGet("c1", "group2", "variable1", &getType, &getValue));
    TEST_ASSERT_FALSE(
        configGet("c2", "group1", "variable1", &getType, &getValue));
}
 ...
 *
 */
TEST_CASE("canTeardownConfigvariables", "[config][qemu]") {
    TEST_ASSERT_FALSE(configUnregister("c1", true));
    TEST_ASSERT_EQUAL_FLOAT(1.11, c1group1variable1);
    TEST_ASSERT_EQUAL_FLOAT(1.12, c1group1variable2);
    TEST_ASSERT_EQUAL_FLOAT(1.21, c1group2variable1);
...
#ifndef TEST_IN_QEMU
    // kein Memoryleak
    TEST_ASSERT_LESS_OR_EQUAL(freeHeap,
